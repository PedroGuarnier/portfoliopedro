...
const translations = {
  pt: {
    ...
    'hero.role': 'Software Developer · IT & Automation · Building legal tech solutions at Zveiter | CS @ Estácio',
    'hero.bio': 'Desenvolvedor com background em Marketing — combino visão de produto com capacidade técnica. No <strong>Escritório de Advocacia Zveiter</strong> construo dashboards, automações e soluções de IA aplicada ao direito desde 2024. Graduação em Marketing e Ciência da Computação pela Estácio.',
    'hero.cv': 'Baixar CV',
    ...
    'contact.role': 'Software Developer · Zveiter',
  ...
  en: {
    ...
    'hero.role': 'Software Developer · IT & Automation · Building legal tech solutions at Zveiter | CS @ Estácio',
    'hero.bio': 'Developer with a Marketing background — I combine product vision with technical capability. At <strong>Zveiter Law Firm</strong> I build dashboards, automations and AI solutions applied to law since 2024. Degrees in Marketing and Computer Science from Estácio.',
    'hero.cv': 'Download CV',
